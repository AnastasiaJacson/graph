...
chat_prompt = ChatPromptTemplate.from_messages(
    [
        ("system", "You are a twitter expert providing information about tweets."),
        ("human", "{input}"),
    ]
)
...
tools = [
    Tool.from_function(
        name="General Chat",
        description="For general twitter chat not covered by other tools",
...
Do not answer any questions that do not relate to tweets or twitter.
